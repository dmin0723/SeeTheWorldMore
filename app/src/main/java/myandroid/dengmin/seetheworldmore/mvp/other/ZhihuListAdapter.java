...
public class ZhihuListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements RealmChangeListener{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType == TYPE_BANNER){
            View view = inflater.inflate(myandroid.dengmin.seetheworldmore.R.layout.fragment_news_banner,parent,false);
            return new BannerViewHolder(view);
        }else if(viewType == TYPE_HEADER){
            View view = inflater.inflate(myandroid.dengmin.seetheworldmore.R.layout.fragment_news_header,parent,false);
            return new HeaderViewHolder(view);
        }else if(viewType == TYPE_FOOTER){
            View view = inflater.inflate(myandroid.dengmin.seetheworldmore.R.layout.footer_loading,parent,false);
            return new FooterViewHolder(view);
        }else{
            View view = inflater.inflate(myandroid.dengmin.seetheworldmore.R.layout.fragment_fresh_item,parent,false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        textGrey = ContextCompat.getColor(context, myandroid.dengmin.seetheworldmore.R.color.darker_gray);
        textDark = ContextCompat.getColor(context, myandroid.support.design.R.color.abc_primary_text_material_light);

        if(holder instanceof ViewHolder){
            final ViewHolder viewHolder = (ViewHolder) holder;
            if(position == 1){
                viewHolder.header.setText(context.getString(myandroid.dengmin.seetheworldmore.R.string.hot));
    ...
    public class HeaderViewHolder extends RecyclerView.ViewHolder{
        ...
        public HeaderViewHolder(View view){
            super(view);
            headerText = (TextView) view.findViewById(myandroid.dengmin.seetheworldmore.R.id.story_header);
        }
    }
    ...
    public class BannerViewHolder extends RecyclerView.ViewHolder{
        ...
        public BannerViewHolder(View view){
            super(view);
            banner = (ConvenientBanner) view.findViewById(myandroid.dengmin.seetheworldmore.R.id.convenientBanner);
        }
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View view){
            super(view);
            header = (TextView) view.findViewById(myandroid.dengmin.seetheworldmore.R.id.story_header);
            mImage = (ImageView) view.findViewById(myandroid.dengmin.seetheworldmore.R.id.story_img);
            mTitle = (TextView) view.findViewById(myandroid.dengmin.seetheworldmore.R.id.news_title);
            mItem = view.findViewById(myandroid.dengmin.seetheworldmore.R.id.news_item);
        }
    }
}
